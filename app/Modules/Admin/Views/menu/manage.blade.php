    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            {!! init_datatable([
                ...
                trans('name'),
                trans('route'),
                '<a class="btn btn-success btn-sm" href="' . route('admin.menu.create') . '">' . trans('create') . '</a>
                    <button type="button" class="btn btn-danger btn-sm btn-bulk-delete" data-href="' . route('admin.menu.delete') . '">' . trans('bulk_delete') . '</button>'
            ], 'menu') !!}
        </div>
    </div>
@endsection
...
@section('scripts')
    <script>
        $(document).ready(function(){
            // Datatable
            init_datatable('dtable-menu', window.location.href + '/datatable', {
